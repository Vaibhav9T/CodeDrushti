      ...
      <div className="w-full max-w-md bg-[#161b22] border border-gray-800 rounded-2xl p-8 shadow-2xl relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-sm text-cyan-500 hover:text-cyan-400 transition-colors font-medium">
              Forgot Password?
            </Link>
          </div>
        ...
        <div className="flex justify-center gap-4">
          ...
          {/* GitHub Button */}
          <button className="p-3 bg-[#0d1117] border border-gray-700 rounded-full hover:bg-gray-800 hover:border-gray-600 transition-all group" onClick={handleGithubSignIn}>
