...
import { Search, ShieldCheck, Wand2, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-10 lg:p-16 border border-gray-100 dark:border-slate-800 relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] transition-colors duration-300 mt-8">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button 
              className="group flex items-center justify-center bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-semibold px-8 py-3.5 rounded-xl transition-all shadow-md hover:shadow-lg dark:shadow-indigo-500/20 active:scale-[0.98]" 
